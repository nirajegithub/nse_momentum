...
def get_completed_15m_cutoff(scan_time: datetime):
    ...
    With the current resampling:
      [09:15, 09:30) -> 09:30
      [09:30, 09:45) -> 09:45

    Therefore:
      09:25 -> NO current-day completed 15M candle
      09:30 -> 09:30 is the first completed 15M candle
    """
...
def filter_completed_candles(
    ...
    This is important because Dhan returns historical candles from
    previous trading days as well.
    """
...
def run_scan(
    ...
    if cutoff_15m:
        ...
        logger.info(
            "15M latest allowed | NONE (first 15M candle completes at 09:30)"
        )
